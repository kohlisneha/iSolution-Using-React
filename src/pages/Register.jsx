...
//         title: "Do you want to Register With iSolutions",
//         showDenyButton: true,
...
//         });
//         Swal.fire(
//           "Congratulations! You Have Successfully Registered with iSolutions",
//           "",
//           "success"
//         );
//         navigate("/login");
...
const Register = () => {
  ...
  const onFinish = async (values) => {
    try {
      ...
      if (result.isConfirmed) {
        // Concatenate the prefix and phone number
        const mobile = `${values.prefix}${values.phone}`;
